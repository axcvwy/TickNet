    ...
    <div class="max-w-md w-full space-y-8">
      <div>
        ...
        <p class="mt-2 text-center text-sm text-gray-600">
          Ou
          <router-link to="/register" class="font-medium text-orange-600 hover:text-orange-500 transition-colors">
        ...
        <div>
          ...
          >
            <span class="absolute left-0 inset-y-0 flex items-center pl-3">
              ...
              <svg
                class="h-5 w-5 text-orange-200 group-hover:text-white transition-colors"
